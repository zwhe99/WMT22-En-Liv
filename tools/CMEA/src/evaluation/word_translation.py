...
def get_word_translation_accuracy(lang1, word2id1, emb1, lang2, word2id2, emb2, method, dico_eval):
    ...
    emb1_norm = emb1.norm(2, 1, keepdim=True).expand_as(emb1)
    emb2_norm = emb2.norm(2, 1, keepdim=True).expand_as(emb2)

    nonzero1 = emb1_norm > 0
    emb1[nonzero1] /= emb1_norm[nonzero1]

    nonzero2 = emb2_norm > 0
    emb2[nonzero2] /= emb2_norm[nonzero2]
