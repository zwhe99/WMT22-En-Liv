...
from src.utils import bool_flag, initialize_exp, Dictionary
...
# main
parser = argparse.ArgumentParser(description='Supervised training with inconsistent dimension')
...
parser.add_argument("--tgt_emb_dim", type=int, default=300, help="Embedding dimension")
...
for n_iter in range(params.n_refinement + 1):
    ...
    to_log = OrderedDict({'n_iter': n_iter, VALIDATION_METRIC: 0})
    if params.eval:
